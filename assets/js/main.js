...
(function() {
  ...
  // Handle Form Submission Google Apps Script Setup (Backend) - New
  /*
  ...
  fetch("https://script.google.com/macros/s/AKfycby7VjkpI9b7qz4rC9B5QOXNhkgwDVRy9C53HWxU2vL_S9hdE9Pei0gwEasQ2-Zflmcc/exec", {
    ...
    .then(data => {
      ...
      if (data.status === "success") {
        ...
        document.getElementById("message-field").value = ''; // Clear the message field
      } else {
        // Display the error message returned from the server
        document.querySelector('.error-message').textContent = data.message || "An unknown error occurred.";
...
=========================================================*/
 ...
 // Handle Form Submission Google Apps Script Setup (Backend) - Old Error "TypeError: Failed to fetch"
